...
class MarkovTransitionMatrixFlow : public MarkovTransitionMatrix {
    public:
        MarkovTransitionMatrixFlow(const std::vector<heiFIBPacketImage>& packets, uint cols = 4) : packets(packets), cols(cols), MarkovTransitionMatrix() {

            std::vector<std::vector<std::vector<double>>> result;
            MarkovTransitionMatrix M = MarkovTransitionMatrix();
        ...
        std::vector<std::vector<double>> npzero(int dim) {
        ...
        std::vector<std::vector<double>> tile_images(const std::vector<std::vector<std::vector<double>>>& images, const uint cols, const uint dim) {
            ...
            int k = 0; // Index to track current image
