...
public:
    ...
    void create_image(
        ...
        std::visit([](auto& matrix) {
            std::cout << std::to_string(matrix.size()) << std::endl;
        }, img);
...
int main() {
    ...
    std::string output_dir = "/Users/henrirebitzky/Desktop/";  // Update with actual output path
    ...
    runner.create_image(
        input_file, 
        output_dir,
        args5,  // args placeholder
        pbar,
        PacketProcessorType::HEADER,  // Example of using HEADER processing
        ImageType::MarkovTransitionMatrixPacket,  // Example: pass nullptr for NetworkTrafficImage
        3,  // min_image_dim
        2000,  // max_image_dim
